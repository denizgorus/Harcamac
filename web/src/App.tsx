...
function Dashboard({ entries, assets }: { entries: Entry[]; assets: Asset[] }) {
  ...
  return <div className="page-content">
    ...
    <section className="chart-grid" data-tour="charts">{defaultWidgets.map(widget=><article className="panel chart-card" key={widget.id}><ChartHeader widget={widget}/><ChartBody widget={widget} entries={entries}/></article>)}
    </section>
