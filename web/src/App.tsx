...
function AssetDetail({asset,formatMoney,watched,close,toggleWatch,trade}:{asset:Asset;formatMoney:(value:number)=>string;watched:boolean;close:()=>void;toggleWatch:()=>void;trade?:(side:'buy'|'sell')=>void}) {
